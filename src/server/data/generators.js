...
export const generateNetworkTopology = (type = simulationState.currentTopologyType) => {
  // Use the internal engine to build the layout based on topology type
  const { gNBs, UEs } = getTopologyLayout(type);
