...
const Navigation = ({ isOpen }) => {
    ...
    const navItems = [
        ...
        { path: '/hotspot', label: 'Network Node', icon: 'M8.11 11.07a4.48 4.48 0 00-3.32 1.35m14.42 0a4.48 4.48 0 00-3.32-1.35m-7.1 5.39a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm-3.41-3.41a4.82 4.82 0 016.82 0m-9.09-2.27a8.03 8.03 0 0111.36 0' }, // Wifi
